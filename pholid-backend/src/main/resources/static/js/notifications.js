...
const notifications = (() => {
        ...
        if (Notification.permission === 'granted') {
            ...
            try {
                const notification = new Notification('🎬 Render Complete!', {
                    ...
                    icon: '/svg/pholid.svg',
                    badge: '/svg/pholid.svg',
                    tag: 'pholid-render-complete', // Prevents notification spam
    ...
    function init() {
        ...
        document.addEventListener('pholid:jobSubmitted', requestPermission);

        // Listen for render completion
        document.addEventListener('pholid:renderComplete', (e) => {
