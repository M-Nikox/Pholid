...
const JOB_TYPE = {
  label: 'Cycles CUDA GPU',
  description:
    'CUDA GPU rendering + extra checkboxes for some experimental features + extra CLI args for Blender',
  settings: [
...
for dev in cycles_prefs.get_devices_for_type('CUDA'):
