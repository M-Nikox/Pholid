...
class IdValidatorTest {
    ...
    // ── Pangolin IDs (16 lowercase hex chars) ──────────────────────────────

    @Test
    void validPangolinId_accepted() {
        assertThat(IdValidator.isValidPangolinId("a1b2c3d4e5f60718")).isTrue();
    }
    ...
    void invalidPangolinId_rejected(String id) {
        assertThat(IdValidator.isValidPangolinId(id)).isFalse();
    }

    @Test
    void nullPangolinId_rejected() {
        assertThat(IdValidator.isValidPangolinId(null)).isFalse();
    }
